...
/////////////////////////////////////////////////////////////
require('./routes/keepalive.js'); // Keep the server alive
...
app.use(cors({
  origin: '*',
  origin: [`${process.env.FRONTEND_URL}`, `http://127.0.0.1:${process.env.PORT}`,
    `${process.env.URL}:${PORT}`, `http://localhost:${process.env.PORT_F}`], // Frontend URLs
